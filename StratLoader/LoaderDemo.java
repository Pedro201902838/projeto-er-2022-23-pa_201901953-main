...
public void loadStops() throws FileNotFoundException{
    try {
        ...
        Scanner scanner = new Scanner(new File("datasets/demo/stops.txt"));
        String line = "";
        int count = 0;
    ...
    public void loadFXCoordinatesForStops() throws FileNotFoundException{
            try {
                ...
                Scanner scanner = new Scanner(new File("datasets/demo/xy.txt"));
                String line = "";
                int count = 0;
                while (scanner.hasNext()) {
    ...
    public void loadRouteDuration() throws FileNotFoundException{
            try {
                ...
                Scanner scanner = new Scanner(new File("datasets/demo/routes-duration.txt"));
                String line = "";
                int count = 0;
                while (scanner.hasNext()) {
    ...
    public void loadRouteDistance() throws FileNotFoundException{
            try {
                ...
                Scanner scanner = new Scanner(new File("datasets/demo/routes-distance.txt"));
                String line = "";
                int count = 0;
                while (scanner.hasNext()) {
